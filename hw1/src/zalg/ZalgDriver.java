...
//		}
		ZalgImp zalg = new ZalgImp("TEST$ASTESLGHSLTETEST");
		//zalg.Zalg("TEST$ASTESLGHSLTETEST");
	}

//	public static int naiveSearch(String s, int indexToStartOn, int currentIndex) {
//		int count = 0;
//
